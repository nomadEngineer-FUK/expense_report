    ...
    <div class="input-group-block">
        ...
        <div class="input-form-group input-expense-detail">
            ...
            <div class="form-row-group">
                <div class="form-field">
                    ...
                    <select name="accounting-item" id="accounting-item">
                        <option v-for="accountingItem in accountingItems" :key="accountingItem.id">
                            {{ accountingItem.name }}
                        </option>
                    </select>
                </div>
            ...
            <div class="form-field">
                ...
                <textarea class="width-ninety-five" name="note-by-applicant" id="note-by-applicant"></textarea>
            </div>
        </div>
    </div>
</template>
